 ...
 * @suttlemedia/store-d1-client/tests/adoption/agent-store-adoption.test.ts).
 */
...
describe('BP-09 hygiene walls', () => {
  it('@uvrn/agent src stays free of d1/cloudflare/wrangler/@suttlemedia/store-d1-client imports', () => {
