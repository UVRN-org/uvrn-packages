...
/**
 * MeasurementType names a relationship check such as agree, disagree, conflict, or potential.
 * The open string form lets hosts define custom measurement modules without changing core.
 */
